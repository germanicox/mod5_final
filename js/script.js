...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      console.log(homeHtmlToInsertIntoMainPage); //test formating short name with ' 

      homeHtml =       insertProperty(homeHtml,"randomCategoryShortName",homeHtmlToInsertIntoMainPage);

      console.log(homeHtml); // check if special sorted was succesfully updated in homehtml snippet 
